...
/**
 * A specialized {@link Map} implementation for use with enum type keys.  All |EnumMap EnumSet  存储enum元素，底层实现
 * of the keys in an enum map must come from a single enum type that is       |也做了优化
